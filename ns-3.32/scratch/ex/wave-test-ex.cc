...
{
  std::cout << BOLD_CODE << YELLOW_CODE << "--START--Packet Rx!--START--" << END_CODE << std::endl;
  ...
  std::cout << BOLD_CODE << YELLOW_CODE << "--END--Packet Rx!--END--" << END_CODE << std::endl;
}
...
{
	std::cout << BOLD_CODE << YELLOW_CODE << "--START--Packet Rx Dropped!--START--" << END_CODE << std::endl;
  ...
  std::cout << BOLD_CODE << YELLOW_CODE << "--END--Packet Rx Dropped!--END--" << END_CODE << std::endl;
}
